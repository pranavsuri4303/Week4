...
//import ss.calculator.implementation.CalculatorImpl;
//
...
//        calculator = new CalculatorImpl(); // FIXME replace with the actual calculator
//    }
//
//    @Test
...
//
//        // test with negative numbers: -100 % 6 = -4
//        calculator.push(-100);
//        calculator.push(6);
//        calculator.mod();
//        assertEquals(-4.0, calculator.pop());
...
//        assertEquals(1, calculator.pop()); // check stack is unchanged
//        assertThrows(StackEmptyException.class, () -> calculator.mod());
//    }
//}
